...
//
//import com.cat.zsy.strategy.TongStockCompoundIndicators
//
...
//    Option.empty,
//    // 周期
//    Option(StatisticsDuration().count),
//    // 单价
//    Option(30.0),
//
//    // 低谷
...
//
//    filter.codes.map(o => { t: TongStockCompoundIndicators => o.contains(t.stock.code) }).foreach(buffer += _)
//
